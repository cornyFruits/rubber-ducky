...
if (board.board_id == 'raspberry_pi_pico'):
    ...
    noStorage = not noStorageStatus # original

elif (board.board_id == 'raspberry_pi_pico_w'):
    # on Pi Pico W, default to USB hidden by default
    # so webapp can access storage -- changed to USB visible
    # noStorage = noStorageStatus # original
    # Always keep USB visible, change to original to enable stealth mode
    noStorage = False
